 ...
 * 
 * @author vu_anh
 * Description: Write a method called toMilesPerHour that has 1 parameter of type double with the name kilometersPerHour. This method needs to return the rounded value of the calculation of type long.
...
public class SpeedConverter {
	public static void main(String[] args) {
		...
		System.out.println("Type number of kilometer/hour: ");
		double kilometersPerHour = n.nextDouble();
	...
	public static double toMilesPerHour (double kilometersPerHour) {
		...
		double converted = (long)Math.round(milesPerHour);
		return converted;
